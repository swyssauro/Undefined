            ...
            <Grid.Row>
                <Grid.Column style={{ background: '#006aff' }}>
                    <div className="left-box-description">
                        <div className="style-box-icons"><FiMap color="#006aff" size="30" /></div>
                        <h1 className="title-left-box">welcome<br/><b className="title-welcome">{UserName}</b></h1>
                        <p className="font-description">criamos essa pagina para dar boas vindas a você.</p>
                    </div>
